...
class TFIDF:
    def __init__(self):
        ...
        self.idf_file = os.path.join(current_folder_path, 'idf.txt')
    ...
    def build_wordsdict(self, text):
        ...
        for word in pseg.cut(text):
            ...
            if word.flag[0] in ['n'] and len(word.word) > 1:
    ...
    def extract_keywords(self, text, num_keywords):
        ...
        for word, word_tf in candi_dict.items():
            ...
            # print('self.common_idf', self.common_idf)
